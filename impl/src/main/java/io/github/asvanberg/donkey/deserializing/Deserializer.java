...
public class Deserializer implements DeserializationContext {
    ...
    private void registerBuiltInDeserializers()
    {
        ...
        deserializers.put(float.class, FloatCodec.INSTANCE);
        deserializers.put(Double.class, DoubleCodec.INSTANCE);
        deserializers.put(double.class, DoubleCodec.INSTANCE);
        ...
        deserializers.put(Boolean.class, BooleanCodec.INSTANCE);
        deserializers.put(OptionalInt.class, OptionalIntCodec.INSTANCE);
        deserializers.put(OptionalLong.class, OptionalLongCodec.INSTANCE);
        deserializers.put(OptionalDouble.class, OptionalDoubleCodec.INSTANCE);
        deserializers.put(Instant.class, InstantCodec.INSTANCE);
        deserializers.put(OffsetDateTime.class, OffsetDateTimeCodec.INSTANCE);
        deserializers.put(LocalDateTime.class, LocalDateTimeCodec.INSTANCE);
